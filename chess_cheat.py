...
interface PieceMover {
    public void move(Point fr, Point to);
}

class PieceDragger implements PieceMover {
    @Override
    public void move(Point fr, Point to) {
...
class PieceTeleporter implements PieceMover {
    @Override
    public void move(Point fr, Point to) {
...
interface ChessBoard {
    public void movePiece(PieceMover pieceMover);
}
...
Goal:
Need a NotationReader
- Notation detector
- read()

Need a way to move pieces
- move(Point A, Point B)

Need a CornerDetector
- detectCorners()
- ChessBoard detector
- Notation detector
